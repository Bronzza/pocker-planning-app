...
public class MemberController {
    ...
    @PostMapping
    public ResponseEntity<MemberDto> createMember(@PathVariable Long sessionId,
    ...
    @PutMapping
    public ResponseEntity enterUserStory(@PathVariable Long sessionId,
                                         @Valid @RequestBody MemberStoryDto memberStoryDto) {
        memberService.enterStory(sessionId, memberStoryDto);
        return new ResponseEntity(HttpStatus.OK);
    }

    @Deprecated
    @DeleteMapping("/{memberId}")
    public ResponseEntity deleteMember(@PathVariable Long sessionId, @PathVariable Long memberId) {
        memberService.logout(sessionId, memberId);
